...
public class BuildNetAnimation : Editor
{

    //生成出的Prefab的路径
    private static string PrefabPath = "Assets/Fish/Prefabs/Net";
    ...
    //美术给的原始图片路径
    private static string ImagePath = Application.dataPath + "/Fish/Pic/Net";
    ...
    */
    ...
    [MenuItem("Build/BuildNetAnimation")]
...
//             }	
    ...
    static void BuildPrefab(DirectoryInfo dictorys, UnityEditor.Animations.AnimatorController animatorCountorller, bool isDirectory)
    {
		...
		go.AddComponent<GameFish.GONet> ();
